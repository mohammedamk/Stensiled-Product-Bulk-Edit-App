...
export async function createServer(
  ...
  app.get('/api/GetShopifyCustomerdata', async (req, res) => {
    try {
      res.send({
        status: true
      });
    } catch (err) {
      console.log('GetShopifyCustomerdata', err)
    }
  });

  app.get('/api/EraseShopifyCustomerdata', async (req, res) => {
    try {
      res.send({
        status: true
      });
    } catch (err) {
      console.log('EraseShopifyCustomerdata', err)
    }
  });

  app.get('/api/EraseShopData', async (req, res) => {
    try {
      res.send({
        status: true
      });
    } catch (err) {
      console.log('EraseShopData', err)
    }
  });
  ...
  app.get("/api/products/get", async (req, res) => {
    ...
    await fetchProducts(req, res, session);
  });

  app.put("/api/products/put", async (req, res) => {
    try {
      ...
      await updateProducts(req, res, session);
      res.send({
        status: true
      });
  ...
  app.get("/api/getCompletedTask", async (req, res) => {

    console.log("COMPLETED TASKS GET API HIT");
    ...
    try {
      const cTasks = await fetchTasks(req, res, session);
      res.send({
        status: true,
        data: cTasks
      });
  ...
  app.post("/api/contactus/post", async (req, res) => {
    try {
      console.log("CONTACT POST API HIT");
